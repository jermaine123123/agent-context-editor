...
| Field | Value |
| --- | --- |
| Package | `context-editor-deepseek-harness@0.3.1` |
...
| Independent units | Reasoning and answer units, hierarchical AI filters, centered search navigation, native context projection, and User/Answer replacement in `0.3.1` |
