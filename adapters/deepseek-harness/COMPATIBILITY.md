...
| Field | Value |
| --- | --- |
| Package | `context-editor-deepseek-harness@0.4.0` |
...
| Independent units | Reasoning and answer units, hierarchical AI filters, centered search navigation, native context projection, User/Answer replacement, and reversible selected-context AI condensation in `0.4.0` |
| Persistence | `context_editor` sidecar with replacement and condensation events; Session log append-only; matching `context/projection` events drive model input |
| UI language | `zh-*` Chinese; all other browser locales English |
| Recorded at | `2026-09-11` |

This release targets the pinned rc.8 boundary. Context exclusion
